return {
    ...
    keys = {
        ...
        { "<leader>d", function() require('telescope.builtin').diagnostics({line_width = 100}) end, desc = "Search diagnostics" },
        { "<leader>/", "<cmd>Telescope live_grep<cr>", desc = "Live grep" },
        { "<leader>s", "<cmd>Telescope lsp_document_symbols<cr>", desc = "Find symbols"},
        { "<leader>S", "<cmd>Telescope lsp_workspace_symbols<cr>", desc = "Find symbols"},
